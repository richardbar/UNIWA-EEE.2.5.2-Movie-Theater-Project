...
public sealed class ReservationService : IReservationService
{
    ...
    public async Task<bool> CreateAsync(Domain.Reservation reservation)
    {
    ...
    public async Task<Domain.Reservation?> GetAsync(Guid id)
    {
        var reservationDto = await _reservationRepository.GetAsync(id);
        return reservationDto?.ToReservation();
    }

    public async Task<IEnumerable<Domain.Reservation>> GetAllAsync()
    {
